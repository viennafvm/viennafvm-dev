...
namespace viennafvm {
  ...
  namespace detail
  {
    ...
    {
      public:
        function_symbol_replacer(viennamath::rt_function_symbol<InterfaceType> u) : u_(u) {}
        ...
        void operator()(viennamath::rt_function_symbol<InterfaceType> const & func_symb) const
        {
          ...
          if (func_symb.id() != u_.id())
          {
            ...
            current_iterate.wrap_constant(viennafvm::current_iterate_key(func_symb.id()));
        ...
        void operator()(viennamath::rt_unary_expr<InterfaceType> const & unary_expr) const
        {
          ...
          if (grad_op != NULL) //this is a gradient
          {
            ...
            if (fs != NULL)
            {
              ...
              {
                viennafvm::ncell_quantity<NCellType, InterfaceType> current_iterate;
                current_iterate.wrap_constant(viennafvm::current_iterate_key(fs->id()));
        ...
        void operator()(viennamath::rt_binary_expr<InterfaceType> const & bin) const
        {
          ...
          {
            viennamath::rt_manipulation_wrapper<InterfaceType> manipulator(new function_symbol_replacer<NCellType, InterfaceType>(u_));
            //Note: In the following, directly passing *this is not possible due to the need for a wrapper...
  ...
  template <typename NCellType, typename InterfaceType>
  viennamath::rt_expr<InterfaceType> extract_surface_integrand(viennamath::rt_expr<InterfaceType> const & ex, viennamath::rt_function_symbol<InterfaceType> const & u)
  {
  ...
  template <typename NCellType, typename InterfaceType>
  viennamath::rt_expr<InterfaceType> extract_volume_integrand(viennamath::rt_expr<InterfaceType> const & ex, viennamath::rt_function_symbol<InterfaceType> const & u)
  {
